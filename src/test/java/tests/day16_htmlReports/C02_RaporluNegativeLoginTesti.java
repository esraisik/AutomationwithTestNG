...
public class C02_RaporluNegativeLoginTesti extends TestBaseRapor {
    ...
    public void gecersizPasswordTesti(){
        ...
        testotomasyonuPage.emailKutusu.sendKeys(ConfigReader.getProperty("toGecerliEmail"));testotomasyonuPage.passwordKutusu.sendKeys(ConfigReader.getProperty("toGecersizPassword"));
    ...
    public void gecersizEmailGecersizPasswordTesti(){
        extentTest = extentReports.createTest("Gecersiz Password GecersizEmaiTesti",
